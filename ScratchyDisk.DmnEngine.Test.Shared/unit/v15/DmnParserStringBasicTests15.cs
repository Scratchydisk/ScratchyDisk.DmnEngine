...
namespace ScratchyDisk.DmnEngine.Test.Unit
{
    ...
    public class DmnParserStringBasicTests15
    {
        [TestMethod]
        public void ParseStringMethodHappyTest()
        {
            var def = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>";
            def += "<definitions xmlns = \"https://www.omg.org/spec/DMN/20230324/MODEL/\" >";
            def += "</definitions>";

            var parsedDef = DmnParser.ParseString15(def);
        ...
        {
            Action act = () => DmnParser.ParseString15(xmlStr);
        ...
        public void ParseWrongStringTest()
        {
            ...
            Action act = () => DmnParser.ParseString15(def);
