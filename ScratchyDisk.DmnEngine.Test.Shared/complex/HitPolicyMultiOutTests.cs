...
namespace ScratchyDisk.DmnEngine.Test.Complex
{
    ...
    public class HitPolicyMultiOutTests : DmnTestBase
    {
        [TestMethod]
        ...
        {
            var ctx = CTX("hitpolicy_MultiOut_Unique.dmn");
        ...
        {
            var ctx = CTX("hitpolicy_MultiOut_First.dmn");
        ...
        {
            var ctx = CTX("hitpolicy_MultiOut_Priority.dmn");
        ...
        {
            var ctx = CTX("hitpolicy_MultiOut_OutputOrder.dmn");
