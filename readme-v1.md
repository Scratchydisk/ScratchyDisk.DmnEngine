...
The test code is in a shared code project that is linked into the consolidated test project `ScratchyDisk.DmnEngine.Tests` targeting .NET 10.0.
...
### Code Documentation ###
The [code documentation](docs/ScratchyDisk.DmnEngine.md) is generated during the customized build using [MarkupDoc](https://github.com/adamecr/MarkupDoc).
